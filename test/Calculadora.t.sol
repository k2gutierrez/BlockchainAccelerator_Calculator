...
contract CalculadoraTest is Test {
    ...
    function testLargenumberMultiplyRevert() public {
        int256 num1 = 57896044618658097711785492504343953926634992332820282019728792003956564819966;
        int256 num2 = 2;
        vm.expectRevert();
        calculadora.multiplication(num1, num2);
    }
